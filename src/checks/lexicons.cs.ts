...
export const HYPE_CS_HARD: readonly LexEntry[] = [
  { id: 'revoluč', source: 'revoluč', kind: 'stem', severity: 'hard' },
  { id: 'převratn', source: 'převratn', kind: 'stem', severity: 'hard' },
  { id: 'senzačn', source: 'senzačn', kind: 'stem', severity: 'hard' },
  { id: 'senzace', source: 'senzace', kind: 'stem', severity: 'hard' },
  { id: 'zázračn', source: 'zázračn', kind: 'stem', severity: 'hard' },
  { id: 'zázrak', source: 'zázrak', kind: 'stem', severity: 'hard' },
  { id: 'šokující', source: 'šokující', kind: 'stem', severity: 'hard' },
  { id: 'šokuj', source: 'šokuj', kind: 'stem', severity: 'hard' },
  { id: 'ohromující', source: 'ohromující', kind: 'stem', severity: 'hard' },
  { id: 'nebýval', source: 'nebýval', kind: 'stem', severity: 'hard' },
  { id: 'bezprecedentn', source: 'bezprecedentn', kind: 'stem', severity: 'hard' },
  { id: 'dechberoucí', source: 'dechberoucí', kind: 'stem', severity: 'hard' },
  { id: 'neuvěřiteln', source: 'neuvěřiteln', kind: 'stem', severity: 'hard' },
  { id: 'úžasn', source: 'úžasn', kind: 'stem', severity: 'hard' },
  { id: 'neskutečn', source: 'neskutečn', kind: 'stem', severity: 'hard' },
  { id: 'epocháln', source: 'epocháln', kind: 'stem', severity: 'hard' },
  { id: 'šílen', source: 'šílen', kind: 'stem', severity: 'hard' },
  { id: 'zaručen', source: 'zaručen', kind: 'stem', severity: 'hard' },
  // 19 — duplicate of `senzačn`; A.1.1 says drop it. Not transcribed.
  { id: 'mění-pravidla-hry', source: 'mění pravidla hry', kind: 'stem', severity: 'hard' },
  { id: 'změnil-pravidla-hry', source: 'změnil pravidla hry', kind: 'stem', severity: 'hard' },
  { id: 'změní-pravidla-hry', source: 'změní pravidla hry', kind: 'stem', severity: 'hard' },
  { id: 'zásadní-zlom', source: 'zásadní zlom', kind: 'stem', severity: 'hard' },
  { id: 'zlomový-okamžik', source: 'zlomový okamžik', kind: 'stem', severity: 'hard' },
  { id: 'zlomový-bod', source: 'zlomový bod', kind: 'stem', severity: 'hard' },
  { id: 'zlomový-moment', source: 'zlomový moment', kind: 'stem', severity: 'hard' },
  { id: 'změna-paradigmatu', source: 'změna paradigmatu', kind: 'stem', severity: 'hard' },
  { id: 'paradigmatický-posun', source: 'paradigmatický posun', kind: 'stem', severity: 'hard' },
  {
    id: 'svatý-grál',
  ...
  { id: 'poprvé-v-historii', source: 'poprvé v historii', kind: 'stem', severity: 'hard' },
  { id: 'mění-svět', source: 'mění svět', kind: 'stem', severity: 'hard' },
  { id: 'změní-svět', source: 'změní svět', kind: 'stem', severity: 'hard' },
  { id: 'navždy-změní', source: 'navždy změní', kind: 'stem', severity: 'hard' },
  { id: 'nová-éra', source: 'nová éra', kind: 'stem', severity: 'hard' },
  { id: 'nový-věk', source: 'nový věk', kind: 'stem', severity: 'hard' },
  {
  ...
  { id: 'jednou-provždy', source: 'jednou provždy', kind: 'stem', severity: 'hard' },
  { id: 'všechno-co-jsme-věděli', source: 'všechno, co jsme věděli', kind: 'stem', severity: 'hard' },
  { id: 'vše-co-víme', source: 'vše, co víme', kind: 'stem', severity: 'hard' },
  {
    id: 'raketový-růst',
  ...
  { id: 'historický-průlom', source: 'historický průlom', kind: 'stem', severity: 'hard' },
  { id: 'historický-milník', source: 'historický milník', kind: 'stem', severity: 'hard' },
  { id: 'historický-úspěch', source: 'historický úspěch', kind: 'stem', severity: 'hard' },
  { id: 'zcela-zásadní', source: 'zcela zásadní', kind: 'stem', severity: 'hard' },
  { id: 'budoucnost-je-tady', source: 'budoucnost je tady', kind: 'stem', severity: 'hard' },
  {
    id: 'zlomov-hyped',
    source: 'zlomov',
    kind: 'stem',
...
export const HYPE_CS_WARN: readonly LexEntry[] = [
  ...
  { id: 'ohromn', source: 'ohromn', kind: 'stem', severity: 'warn', note: 'A.1.2 #41 — ohromné množství is borderline but common.' },
  { id: 'mimořádn', source: 'mimořádn', kind: 'stem', severity: 'warn', note: 'A.1.2 #42 — mimořádná událost is a fixed term.' },
  { id: 'fascinující', source: 'fascinující', kind: 'stem', severity: 'warn', note: 'A.1.2 #43 — mild; too useful to ban outright.' },
  { id: 'dramatick', source: 'dramatick', kind: 'stem', severity: 'warn', note: 'A.1.2 #44 — dramaticky vzrostl is common journalism, still overheated.' },
  { id: 'masivn', source: 'masivn', kind: 'stem', severity: 'warn', note: 'A.1.2 #45 — anglicism for velký; also legitimate in physics (masivní hvězda).' },
  { id: 'obrovsk', source: 'obrovsk', kind: 'stem', severity: 'warn', note: 'A.1.2 #46 — vague magnitude word; prefer a number with an anchor.' },
  { id: 'naprosto', source: 'naprosto', kind: 'stem', severity: 'warn', note: 'A.1.2 #47 — intensifier.' },
  { id: 'zcela', source: 'zcela', kind: 'stem', severity: 'warn', note: 'A.1.2 #48 — intensifier; frequent in legitimate prose so warn only.' },
  { id: 'konečně', source: 'konečně', kind: 'stem', severity: 'warn', note: 'A.1.2 #49 — editorialising ("vědci konečně…").' },
  { id: 'slibn', source: 'slibn', kind: 'stem', severity: 'warn', note: 'A.1.2 #50 — soft hype; the honest form is "zatím jde o rané výsledky".' },
  { id: 'nadějn', source: 'nadějn', kind: 'stem', severity: 'warn', note: 'A.1.2 #51 — as #50.' },
  {
    id: 'zlatý-standard',
  ...
  { id: 'nejvýznamnějš', source: 'nejvýznamnějš', kind: 'stem', severity: 'warn', note: 'A.1.2 #53 — superlative claim.' },
  {
